...
import { ProjectScheduleComponent } from 'app/entities/project-schedule/project-schedule.component';
...
describe('Component Tests', () => {
    describe('ProjectSchedule Management Component', () => {
        let comp: ProjectScheduleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProjectScheduleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.projectSchedules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
