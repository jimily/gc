...
import cn.gc.config.audit.AuditEventConverter;
import cn.gc.domain.PersistentAuditEvent;
...
import static cn.gc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
